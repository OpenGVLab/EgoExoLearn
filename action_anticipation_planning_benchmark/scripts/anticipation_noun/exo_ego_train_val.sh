...
num_source=5881 # number of training data (source) 
num_target=31412 # number of training data (target)


train_source_list=$path_data_root"list_exo_train_ego_exo-feature.txt"
