...
num_source=31412 # number of training data (source) 
num_target=5881 # number of training data (target)


train_source_list=$path_data_root"list_ego_train_ego_exo-feature.txt"
train_target_list=$path_data_root"list_exo_train_ego_exo-feature.txt"
