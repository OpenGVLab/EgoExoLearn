...
num_source=2363 # number of training data (source) 
num_target=2171 # number of training data (target)


train_source_list=$path_data_root'/train_exo_anno_list.txt'
train_target_list=$path_data_root'/train_ego_anno_list.txt'
