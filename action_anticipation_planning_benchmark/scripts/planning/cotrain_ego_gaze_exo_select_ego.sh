...
num_source=4525 # number of training data (source) 
num_target=4525 # number of training data (target)


train_source_list=$path_data_root'/cotrain_ego_gaze_exo_anno_list.txt'
train_target_list=$path_data_root'/cotrain_ego_gaze_exo_anno_list.txt'
